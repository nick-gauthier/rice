...
```{r chelsa-trace}
# this is not portable nor easily downloadable, will have to do something to enable reproducibility. The entire dataset is ~300gb. Instead, we save the data extracted at the archaeological site points later on.
...
# test of using vsicurl to get data w/out download, too slow for most applications
