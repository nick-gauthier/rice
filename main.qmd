...
#| fig-width: 6
#| fig-height: 12
#| fig-cap: "Bootstrapped kernel density estimates of rice's thermal extent throughout the Holocene. Bootstrap resampling accounts for uncertainty in radioarbon and phase-based dating of archaeological rice finds."

boot_1 <- readRDS('data/data-derived/trace_boot.rds') %>%
  filter(time <= -2000) %>%
