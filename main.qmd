...
library(ggridges)
library(patchwork)
# if installing the rnaturalearth libraries yields an error, uncomment and run the line below
...
**Data and materials availability:** All analyses carried out in `R` [@base]. The analysis is run via reproducible `.qmd` notebooks available [here](https://github.com/nick-gauthier/rice) and in the supplementary text. All data required to reproduce the analysis is included with the analysis code repository or available from public sources linked therein.
...
**Other Supplementary Materials for is manuscript include the following:**
...
{{< embed supplementary_figures.qmd#fig-bootstrap >}}

## Fig. S2.

{{< embed supplementary_figures.qmd#fig-recon-timeseries >}}

{{< pagebreak >}}

## Fig. S3.

{{< embed supplementary_figures.qmd#fig-kde-lgmr >}}

{{< pagebreak >}}

## Fig. S4.

{{< embed supplementary_figures.qmd#fig-country-summaries >}}

{{< pagebreak >}}

## Fig. S5.

{{< embed supplementary_figures.qmd#fig-niche-all-models-bio1 >}}

{{< pagebreak >}}

## Fig. S6.

{{< embed supplementary_figures.qmd#fig-niche-all-models-bio10 >}}

{{< pagebreak >}}

## Fig. S7.

{{< embed supplementary_figures.qmd#fig-niche-all-models-bio5 >}}

{{< pagebreak >}}

## Fig. S8.

{{< embed supplementary_figures.qmd#fig-displacement >}}

{{< pagebreak >}}

## Table S1.

{{< embed supplementary_figures.qmd#tbl-quantiles >}}

{{< pagebreak >}}

## Table S2.

{{< embed supplementary_figures.qmd#tbl-country-summaries-table >}}
