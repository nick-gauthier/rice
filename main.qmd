...
#| fig-cap: Land areas projected to exceed each temperature threshold by 2071-2100 from CMIP6 simulations, downscaled by ISIMIP and CHELSA (Karger et al. 2022). Color intensity corresponds to the count of climate model ensemble members surpassing the given threshold at each grid cell.
#| cache: true
#| fig-width: 11.5
#| fig-height: 8
