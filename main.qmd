...
left_join(quants_mod, quants_mod_monfreda, by = 'quantile') %>%
  ...
  kableExtra::add_header_above(tibble(names = c('', 'Mean Annual Temperature', 'Max Temp. of the Warmest Month', 'Max Temp. of the Warmest Quarter'), spans = c(1,4,4,4)))  #%>%
  #kableExtra::save_kable('data/data-derived/quantiles_table.png')
```

![Present-day rice extent quantiles across three datasets of varying resolution and spatiotemporal support, compared to those calculated from archaeological sites in Asia throughout the Holocene](data/data-derived/quantiles_table.png){#tbl-quantiles-2 width="6in"}
