...
format: 
  nature-pdf: #science-pdf: 
    journal: "sn-mathphys-num"#"scicite"
    keep-tex: true
    toc: false
header-includes:
    #- \usepackage{setspace}
